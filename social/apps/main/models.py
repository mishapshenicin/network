...
class UserProfile(models.Model):
	...
	closed_wall = models.IntegerField(default=0)

	avatar = models.TextField('Аватарка')

class Post(models.Model):
	author = models.ForeignKey(User, on_delete=models.CASCADE)
	page = models.ForeignKey(User, on_delete=models.CASCADE, related_name='i_have_post', null=True, blank=True)
	reposted_post = models.IntegerField("репостнутый пост", default=0)
