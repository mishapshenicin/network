...
urlpatterns = [
	...
	path('module_error/', views.module_error, name='module_error'),
	...
	path('repost', views.PostAPIRepost.as_view(), name='post_repost'),

	path('post_<int:postid>/comment', views.PostAPIAddComment.as_view(), name='post_comment'),

	# user
	path('user_create', views.UserAPICreate.as_view(), name='create_user'),
